...
export function FaqSection() {
  ...
  return (
    <section id="faq" className="relative pt-71.25 lg:pt-262">
      <div className="relative mx-auto w-393 lg:w-1440">
        <DotGlow
          tone="purple"
          className="-left-191 top-330 w-714.5 lg:top-754 lg:-left-49 lg:w-1537.75"
        />

        <div className="mx-auto flex w-320 flex-col items-center gap-40 lg:w-1169 lg:gap-100">
          <div className="flex w-320 flex-col items-center gap-24">
            <SectionBadge
              variant="disc"
              icon={<FlashIcon />}
              className="text-u-14 lg:text-u-16"
            >
              {FAQ.badge}
            </SectionBadge>
            <h2 className="w-302 text-center text-u-40/40 font-medium tracking-jumpa lg:w-638 lg:text-u-72/74">
              {FAQ.heading}
            </h2>
          </div>
                ...
                >
                  ...
                  >
                    <span className="flex items-center gap-20 lg:gap-23">
                      ...
                      <span className="text-u-12/16 tracking-jumpa lg:text-u-20/22 lg:font-medium">
                        {item.question}
                      </span>
                    </span>
                    <span
                      aria-hidden="true"
                      className={cn(
                        "flex size-25 shrink-0 items-center justify-center rounded-full text-u-14 transition-all duration-300 lg:size-40 lg:text-u-20",
                        isOpen
                  ...
                  >
                    <div className="overflow-hidden">
                      <p className="pb-10 pr-20 pl-55.25 text-u-10/16 tracking-jumpa text-jumpa-neutral-400 lg:pb-30 lg:pr-30 lg:pl-103 lg:text-u-16/24">
                        {item.answer}
                      </p>
                    </div>
                  </div>
