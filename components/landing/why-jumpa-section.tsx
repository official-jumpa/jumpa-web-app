...
export function WhyJumpaSection() {
  return (
    <section className="relative isolate mt-74 flex flex-col items-center gap-50 overflow-hidden bg-[image:var(--gradient-jumpa-landing)] pt-50 pb-84 md:mt-120 md:gap-100 md:pt-100 md:pb-148">
      <DotGlow
        tone="purple"
        className="-left-55.5 top-1043.5 w-655.5 md:top-1206 md:left-21 md:w-1398.25"
      />
      <img
        src="/images/landing/why-glow-lime.svg"
        alt=""
        aria-hidden="true"
        className="pointer-events-none absolute -z-10 -left-121.25 top-989 h-265.5 w-635.5 max-w-none mix-blend-plus-lighter md:-left-491 md:top-973 md:h-1011 md:w-2421.25"
      />
      ...
      <div className="flex w-320 flex-col items-center gap-20 text-center md:w-781">
        <SectionBadge
          variant="disc"
          icon={<FlashIcon />}
          className="text-u-10.5 md:text-u-16"
        >
          {WHY_JUMPA.badge}
        </SectionBadge>
        <h2 className="text-u-40/40 font-medium tracking-jumpa text-jumpa-white md:text-u-72/75">
          {WHY_JUMPA.heading}
        </h2>
        <p className="text-u-12/18 tracking-jumpa text-jumpa-neutral-50 md:text-u-20/22 md:font-medium">
          {WHY_JUMPA.subhead}
        </p>
      </div>
      ...
      <div className="flex w-320 flex-col gap-130 rounded-u-30 bg-jumpa-primary-300 p-20 shadow-ue-50/5 md:w-1207 md:flex-row md:items-end md:justify-center md:gap-100 md:px-100 md:pt-100 md:pb-50">
        <div className="flex flex-col gap-20 text-jumpa-neutral-50 md:h-full md:flex-1 md:justify-center md:gap-50 md:py-20">
        ...
        <div className="relative h-233 w-full shrink-0 rounded-u-11.25 bg-jumpa-neutral-50 md:h-421 md:w-528 md:rounded-u-22">
