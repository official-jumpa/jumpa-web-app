...
const RING =
  "tap flex h-15 w-full max-w-81.5 justify-center rounded-pill border border-jumpa-primary-300 bg-jumpa-white p-0.5 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50";
const FILL =
